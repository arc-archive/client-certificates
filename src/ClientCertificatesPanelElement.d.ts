...
import { ARCCertificateIndex } from '@advanced-rest-client/arc-types/src/models/ClientCertificate';
...
export declare  class ClientCertificatesPanelElement extends ClientCertificatesConsumerMixin(LitElement) {
   ...
   */
  [listItemTemplate](item: ARCCertificateIndex, index: number, compatibility: boolean): TemplateResult;
